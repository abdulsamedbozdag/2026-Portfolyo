...
const ParticleCanvas = dynamic(
    () => import("@/components/3d/ParticleField").then((mod) => mod.ParticleCanvas),
    { ssr: false }
);
...
export function ParticleHero() {
    return (
        <section className="relative min-h-screen flex flex-col justify-between bg-[#050505] overflow-hidden text-white selection:bg-white selection:text-black dark">
            {/* Particle Background */}
            ...
            <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,transparent_30%,#050505_80%)] pointer-events-none" />
            <div className="absolute bottom-0 left-0 right-0 h-48 z-[1] bg-gradient-to-t from-[#050505] to-transparent pointer-events-none" />
            ...
            <header className="relative z-10 flex items-center justify-between px-8 md:px-16 pt-10">
                <div className="overflow-hidden">
                    <motion.span
                        ...
                        className="block text-[11px] font-medium uppercase tracking-[0.25em] text-neutral-500"
                    >
                        Portfolio © 2026
                    </motion.span>
                </div>
                ...
                <div className="mb-6 md:mb-8">
                    <div className="overflow-hidden">
                        <motion.h1
                            ...
                            className="text-[clamp(3rem,10vw,9rem)] font-bold leading-[0.9] tracking-[-0.04em]"
                        >
                            Abdulsamed
                        </motion.h1>
                    </div>
                ...
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 md:gap-12">
                    <div className="max-w-lg">
                        <div className="overflow-hidden">
                            ...
                            >
                                ...
                                <span className="text-white font-normal"> İletişim Tasarımcısıyım </span>
                    ...
                    <div className="flex-shrink-0 md:text-right">
                        <div className="overflow-hidden">
                            ...
                            >
                                <p className="text-[11px] font-medium uppercase tracking-[0.25em] text-neutral-600 mb-1">
                                    Disiplin
                                </p>
            ...
            <div className="relative z-10 border-t border-neutral-800/60">
                ...
                <div className="overflow-hidden py-5">
                    <motion.div
                        ...
                        className="flex whitespace-nowrap gap-6 text-sm font-medium text-neutral-700 uppercase tracking-[0.15em]"
                    >
                        {[0, 1].map((i) => (
                ...
                <div className="flex justify-center pb-8">
                    ...
                    >
                        ...
                        >
                            <svg width="20" height="30" viewBox="0 0 20 30" fill="none" className="text-neutral-600">
